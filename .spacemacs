...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(gruvbox-dark-medium gruvbox-light-medium spacemacs-dark
                         spacemacs-light)
...
before packages are loaded."
  ...
  (add-hook 'racket-repl-mode-hook (lambda () (set-input-method "TeX")))
